...
st.set_page_config(page_title="Histórico | rosettAI", layout="wide")
render_sidebar()
st.title("Histórico de Atestados")
...
if not documents:
    ...
    if selected_id_short:
        ...
        try:
            ...
            st.error(f"Não foi possível carregar os detalhes: {exc}")
            details = None
        ...
        if details:
            ...
            with col2:
                st.markdown("### Timeline de Processamento")
                for event in events:
